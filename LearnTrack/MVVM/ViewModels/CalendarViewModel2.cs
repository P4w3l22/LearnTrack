...
class CalendarViewModel2
{
    ...
    private void SetCalendarCards()
    {
        ...
        List<DateTime> datesInMonth = new();

        for (int i = 1; i <= daysInMonth; i++)
        {
            datesInMonth.Add(new DateTime(DateTime.Now.Year, DateTime.Now.Month, i));
        }


        var test = new DateTime(2024, 9, 9);
        var dayOfWeek = test.DayOfWeek;
